  ...
  <section class="add">
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="知识点">
        ...
        <el-tag v-else-if="knowledge!=null" class="ml-2" type="success" closable @close="tag_handleClose()">{{knowledge.knowledgeContent}}</el-tag>
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    ...
    onSubmit() { //数据提交
      ...
      if(this.form.courseId==null){
        ...
        this.$axios({
          url: '/admin/addQuestion?knowledgeId='+this.form.knowledgeId,
          method: 'post',
          data: {
            ...this.form
          }
          ...
          if(res.data.code == 200) {
            ...
            this.$router.push({path: '/a_questionManage'})
          }else{
            console.log("数据添加失败")
          }
        })
